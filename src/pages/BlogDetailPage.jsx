    ...
    return (
      <div className="container mx-auto px-4 py-32 text-center animate-fade-in">
        ...
        <p className="text-gray-500 mb-8 max-w-md mx-auto">
          {error || 'Có vẻ như bài viết bạn tìm kiếm không tồn tại hoặc đã bị xóa.'}
        </p>
        <Link
          to="/blog"
          className="bg-orange-600 text-white px-8 py-3.5 rounded-full font-bold shadow-lg hover:shadow-orange-500/30 transition-all hover:bg-orange-700 inline-flex items-center gap-2"
        >
          <ArrowLeft size={16} />
          Quay lại blog
        </Link>
  ...
  return (
    <div className="bg-gray-50 min-h-screen py-12 animate-fade-in">
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <Link
          to="/blog"
          className="inline-flex items-center gap-2 text-sm text-gray-500 hover:text-orange-600 transition mb-8"
        >
        ...
        <article className="bg-white rounded-3xl overflow-hidden shadow-xl border border-gray-100">
          ...
          <div className="p-8 md:p-12">
            ...
            <div className="border-t border-gray-100 pt-8">
              <Link
                to="/blog"
                className="inline-flex items-center gap-2 bg-orange-600 text-white px-6 py-3 rounded-full font-bold hover:bg-orange-700 transition shadow-lg hover:shadow-orange-500/30"
              >
