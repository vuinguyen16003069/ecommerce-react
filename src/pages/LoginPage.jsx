...
const LoginPage = () => {
  ...
  return (
    <AuthLayout title="Mừng trở lại!" subtitle="Vui lòng đăng nhập để tiếp tục mua sắm." image="https://images.unsplash.com/photo-1445205170230-053b83016050?auto=format&fit=crop&w=1200&q=80">
      ...
      <form onSubmit={handleLogin} className="space-y-6">
        <div className="relative group">
          ...
          <input required type="email" value={email} onChange={(e) => setEmail(e.target.value)} className="w-full bg-gray-50 border border-gray-200 rounded-2xl py-4 pl-12 pr-4 text-sm font-medium focus:bg-white focus:ring-4 focus:ring-orange-50 focus:border-orange-400 transition outline-none" placeholder="Email đăng nhập" />
        </div>
        <div className="relative group">
      ...
      <div className="mt-8 text-center"><p className="text-gray-500 font-medium">Chưa có tài khoản? <Link to="/register" className="text-orange-600 font-bold hover:underline">Đăng ký ngay</Link></p></div>
    </AuthLayout>
  )
}
