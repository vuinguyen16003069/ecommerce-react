...
const img = (id) => `https://images.unsplash.com/photo-${id}?auto=format&fit=crop&q=80&w=500`;
...
const mockPosts = [
  {
    ...
    date: '2024-05-01',
    excerpt:
      'Năm nay, các gam màu pastel nhẹ nhàng sẽ lên ngôi. Chất liệu linen thoáng mát là lựa chọn hàng đầu...',
    content:
      'Năm nay, các gam màu pastel nhẹ nhàng sẽ lên ngôi. Chất liệu linen thoáng mát là lựa chọn hàng đầu cho những ngày nắng nóng. Các mẫu váy suông, áo linen trắng là những item không thể bỏ lỡ.',
    image: img('1469334031218-e382a71b716b'),
  },
  {
    ...
    date: '2024-06-15',
    excerpt:
      'Để giày luôn như mới, bạn nên vệ sinh định kỳ 2 tuần/lần. Tránh phơi trực tiếp dưới ánh nắng...',
    content:
      'Để giày luôn như mới, hãy vệ sinh định kỳ 2 tuần/lần bằng xà phòng nhẹ. Tránh phơi trực tiếp dưới ánh nắng. Dùng bột hút ẩm để khử mùi. Thay dây giày khi bị rách để tăng tuổi thọ.',
  ...
  },
  {
    ...
    content:
      'Áo thun trắng là item cơ bản không thể thiếu. 5 cách phối: 1) Jeans skinny, 2) Layer cardigan, 3) Tuck vào chinos, 4) Váy midi, 5) Váy cạp cao.',
    image: img('1622445270936-5dcb604970e7'),
  },
  {
    ...
    content:
      'Những item phụ kiện phải có: túi mini, nón bucket, kính retro, belt da, dây chuyền mạ vàng, đồng hồ, khăn lụa, vòng tay bạc, vành mũ, và giày loafer.',
    image: img('1523293182086-7651a899d37f'),
  },
  {
    ...
    content:
      'Để chọn size chính xác: 1) Đo vòng ngực, 2) Đo dài tay, 3) Đo vòng eo, 4) Đo dài quần, 5) So bảng size của từng thương hiệu.',
  ...
  },
  {
    ...
    content:
      'Bomber jacket → tóc gọn, makeup mạnh. Váy điệu → tóc xoăn nhẹ, makeup nhẹ nhàng. Sơ mi công sở → makeup gọn, tóc buộc cao.',
