...
const ForgotPasswordPage = () => {
  ...
  if (step === 3) {
    return (
      <AuthLayout
        title="Thành công!"
        subtitle="Bạn đã đặt lại mật khẩu thành công."
      ...
      >
        ...
        <Link
          to="/login"
          className="w-full bg-green-600 text-white font-black py-4.5 rounded-2xl shadow-lg hover:bg-green-700 transition-all uppercase tracking-widest text-sm flex items-center justify-center gap-3 group"
        >
          QUAY LẠI ĐĂNG NHẬP{' '}
  ...
  if (step === 2) {
    return (
      <AuthLayout
        title="Xác nhận OTP"
        subtitle="Nhập mã OTP 6 số từ email và mật khẩu mới."
        image="https://images.unsplash.com/photo-1516321318423-f06f70a504f9?auto=format&fit=crop&w=1200&q=80"
      >
        ...
        <div className="mt-8 text-center">
          <button
            type="button"
            onClick={() => setStep(1)}
            className="text-gray-500 font-medium hover:text-orange-600 transition-colors cursor-pointer"
          >
