    ...
    <div className="animate-fade-in">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-2xl">
            ...
            <h1 className="text-5xl md:text-7xl font-black mb-6 leading-tight tracking-tight">
              THỜI TRANG
              <br />
              <span className="text-orange-600 bg-clip-text text-transparent bg-gradient-to-r from-orange-400 to-orange-600">
                MỚI NHẤT
              </span>
            </h1>
            <p className="text-lg text-gray-300 mb-8 max-w-lg leading-relaxed">
              Khám phá những xu hướng thời trang được chọn lọc kỹ lưỡng, phù hợp với mọi phong cách
              của bạn.
            </p>
            <div className="flex gap-4">
              <Link
                to="/shop"
                className="bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 text-white px-8 py-4 rounded-full font-bold transition-all shadow-lg hover:shadow-orange-500/30 flex items-center gap-2 group"
              >
                Mua sắm ngay{' '}
              ...
              <Link
                to="/shop"
                className="bg-white/10 hover:bg-white/20 backdrop-blur text-white px-8 py-4 rounded-full font-bold transition"
              >
                Xem tất cả
              </Link>
            </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-6 grid grid-cols-3 gap-8 divide-x divide-gray-100 border border-gray-50">
          <div className="flex items-center gap-4 px-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500">Cho đơn hàng từ 299K</p>
            </div>
          </div>
          <div className="flex items-center gap-4 px-4">
            <div className="w-12 h-12 flex items-center justify-center text-3xl">🔒</div>
            <div>
              <h4 className="font-bold text-gray-900">Thanh toán an toàn</h4>
          ...
          <div className="flex items-center gap-4 px-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500">Miễn phí đổi trả</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="container mx-auto px-4 mb-20">
        <div className="flex justify-between items-end mb-8">
          ...
          <Link
            to="/shop"
            className="text-orange-600 font-bold hover:text-orange-700 flex items-center gap-1 group"
          >
            Xem thêm{' '}
