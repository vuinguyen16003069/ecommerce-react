          ...
          {fmt(timeLeft)
            ...
            .map((n, i) => (
              <span key={i} className="flex items-center gap-1">
                ...
                <span className="bg-gray-900 text-white px-2 py-1 rounded-md min-w-[32px] text-center">
                  {n}
                </span>
              </span>
            ))}
        ...
        {items.map((p) => {
          ...
          return (
            <Link
              ...
              className="bg-white border border-orange-100 rounded-xl overflow-hidden hover:shadow-lg transition cursor-pointer group"
            >
              <div className="relative">
                <div className="absolute top-0 left-0 bg-red-500 text-white text-[10px] font-black px-2 py-1 rounded-br-lg z-10">
                  -{discount}%
                </div>
                <img
                  src={p.image}
