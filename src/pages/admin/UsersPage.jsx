    ...
    <div className="bg-white rounded-xl border border-gray-100 shadow-sm overflow-hidden">
      <div className="p-5 border-b border-gray-100">
        <div className="flex flex-wrap justify-between items-center gap-3">
          <h3 className="font-bold text-gray-900">Quản lý người dùng ({displayed.length}/{users.length})</h3>
          ...
          {displayed.map((u) => {
            ...
            return (
              <tr key={id} className="hover:bg-gray-50 transition">
                <td className="p-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      {u.isEmailVerified && <span className="text-[10px] text-green-600 font-semibold">✓ Đã xác thực</span>}
                    </div>
                  </div>
                </td>
                ...
                <td className="p-4">
                  <span className={`text-xs px-2 py-1 rounded-lg font-semibold ${u.status === 'active' ? 'bg-green-100 text-green-700' : 'bg-red-100 text-red-700'}`}>
