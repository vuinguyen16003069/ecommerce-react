    ...
    return (
      <div className="container mx-auto px-4 py-24 animate-fade-in max-w-2xl text-center">
        ...
        <p className="text-gray-600 mb-10 max-w-sm mx-auto text-lg leading-relaxed">
          Đừng để giỏ hàng trống trải như vậy. Hàng ngàn sản phẩm thời trang mới nhất đang chờ bạn
          khám phá!
        </p>
        <Link
          to="/shop"
          className="group bg-gray-900 text-white px-12 py-4.5 rounded-2xl font-bold shadow-2xl hover:bg-orange-600 hover:-translate-y-1 transition-all inline-flex items-center gap-3 text-lg"
        >
          KHÁM PHÁ NGAY{' '}
        ...
        <div className="flex-1 space-y-4">
          {cart.map((item) => (
            <div
              ...
              className="bg-white p-5 rounded-2xl border border-gray-100 shadow-sm flex gap-5 hover:border-orange-200 transition group relative overflow-hidden"
            >
              <Link
        ...
        <div className="w-full lg:w-[400px] sticky top-24">
          <div className="bg-white rounded-3xl border border-gray-100 shadow-xl p-8 mb-6 relative overflow-hidden">
            ...
            <div className="space-y-4 text-sm border-t border-gray-100 py-6 mb-2">
              ...
              {couponDiscount > 0 && (
                <div className="flex justify-between text-green-600 font-bold animate-fade-in">
                  <span className="flex items-center gap-1">↳ {couponCode}</span>
            ...
            <button
              ...
              className="w-full bg-gray-900 text-white font-bold py-4.5 rounded-2xl hover:bg-orange-600 transition shadow-lg hover:shadow-xl flex items-center justify-center gap-3 text-lg uppercase tracking-wide group cursor-pointer"
            >
              THANH TOÁN{' '}
              <ArrowRight size={20} className="group-hover:translate-x-1.5 transition-transform" />
            </button>
